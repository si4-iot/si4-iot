...
//const char* ssid = "Lucas Giovani";
//const char* password = "59456797";
//const char* ssid = "LPRM-EXP";
//const char* password = "lprm666!";
...
void callback_lightled(coapPacket *packet, IPAddress ip, int port,int obs) {
 ...
 // Serial.println(message);
  ...
  if (message.equals("\"off\"") || message.equals("off"))
    LEDSTATE = false;
  else if (message.equals("\"on\"") || message.equals("on"))
    LEDSTATE = true;
...
void descricao() {
 // Serial.println("descri");
  ...
  char msg[2048];
   ...
   JsonObject sta = proper.createNestedObject("status_led");
   sta["description"] = "Shows the current status of the led";
   sta["contentType"] = "text/plain";
   ...
   nestedForms["href"] = "coap://"+ip+":5683/ligthled";
   nestedForms["cov:methodName"] = "GET";

   JsonObject dhtsensor11 = proper.createNestedObject("status_dht11");
   ...
   nestedForms2["href"] = "coap://"+ip+":5683/dht11";
   nestedForms2["cov:methodName"] = "GET";

   JsonObject dhtsensor22 = proper.createNestedObject("status_dht22");
   ...
   nestedForms3["href"] = "coap://"+ip+":5683/dht22";
   ...
   nestedForms4["href"] = "coap://"+ip+":5683/lightled";
...
//  pinMode(D1, OUTPUT); // define como saida o pino do buzzer
