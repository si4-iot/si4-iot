//node packages/cli/dist/cli.js examples/scripts/counter-client-segundos.js como executar a partir da pasta thingweb.node-wot


WoTHelpers.fetch("http://192.168.100.109:80/info").then( async (td) => {
